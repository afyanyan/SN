...
def main():
    ...
    lc_directory = r'C:\Users\conno\New folder\SN\O4_SN\o4_supernovae\SN_2025kq'
#C:\Users\conno\New folder\SN\O4_SN\o4_supernovae\SN_2023abdg
    ...
    combined_lc_df = combined_lc_df[~np.isclose(combined_lc_df['MJD'], 60618.80947)]
    combined_lc_file = 'combined_lightcurve.csv'
    combined_lc_df.to_csv(combined_lc_file, index=False)

    supernova = SN(bkg=r'C:\Users\conno\New folder\O4_SN\o4_BKG\sn_2025kq_goto_L_ul.dat', lc = combined_lc_file)
    # Load supernova data
